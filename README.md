...
Los scripts completos están en la carpeta [`/SQLScripts`](./TestNuxibaAPI/SQLScripts/)

---

### Query 1 — Usuario con MÁS tiempo logueado
[`SQLScripts/01_usuario_mas_logueado.sql`](./TestNuxibaAPI/SQLScripts/01_usuario_mas_logueado.sql)
...
[`SQLScripts/02_usuario_menos_logueado.sql`](./TestNuxibaAPI/SQLScripts/02_usuario_menos_logueado.sql)
...
[`SQLScripts/03_promedio_por_mes.sql`](./TestNuxibaAPI/SQLScripts/03_promedio_por_mes.sql)
